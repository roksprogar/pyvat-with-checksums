...
def _check_12_digit_inn(
    vat: str, multipliers_m2: List[int], multipliers_m3: List[int]
) -> bool:
    if len(vat) == 12:
        total1 = 0
        for j in range(11):
...
def calc_russia(vat: str) -> bool:
    ...
    return _check_10_digit_inn(vat, multipliers["m_1"]) or _check_12_digit_inn(
        vat, multipliers["m_2"], multipliers["m_3"]
    )
