...
def _is_standard_or_commercial_number(vat: str, multipliers: list) -> bool:
    ...
    if (check_digit == int(vat[7:9]) and 
        no < 9990001 and 
        (no < 100000 or no > 999999) and 
        (no < 9490001 or no > 9700000)):
        return True
...
def calc_united_kingdom(vat: str) -> bool:
    ...
    return _is_standard_or_commercial_number(vat, united_kingdom.rules['multipliers']['common'])
