...
def is_legal_entities(vat: str, multipliers: List[int], additional: List[re.Pattern]) -> bool:
    total = 0
...
def is_individual_type2(vat: str, multipliers: List[int], additional: List[re.Pattern], lookup: Optional[List[int]]) -> bool:
    total = 0
...
def calc_czech_republic(vat: str) -> bool:
    ...
    return (
        is_legal_entities(vat, multipliers['common'], additional) or
        is_individual_type2(vat, multipliers['common'], additional, lookup) or
        is_individual_type3(vat, additional) or
        is_individual_type1(vat, additional)
    )
