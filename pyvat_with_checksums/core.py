...
def is_vat_valid_to_regexp(vat: str, regex_arr: List[re.Pattern]) -> Dict[str, Union[bool, Optional[re.Pattern]]]:
...
def check_vat(vat: str, countries_list: List[Country] = None) -> VatCheckResult:
    ...
    for country in get_countries(clean_vat, countries_list):
        ...
        is_valid_format = is_vat_valid_to_regexp(clean_vat, country.rules['regex'])['is_valid']
